...
public class EasyCommon extends MainActivity {
Button b1;
Button b2;
Button b3;
Button b4;
...
EditText counter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easycommon);
...
//        int[] arr=getResources().getIntArray(R.array.flags);
        ...
        int resID = getResources().getIdentifier(RightAns, "drawable", getPackageName());
        im1.setImageResource(resID);
  //     im1.setForeground(getDrawable(resID));
//        switch (RightAns){
